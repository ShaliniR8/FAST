 ...
 //    };
 	...
 	if($('.sweet-4').length){
        ...
        function(){
          swal({
          	title: "Deleted!",
	        text: "The asset entry has been deleted!",
	        type: "success",
      	  ...
      	  function(isConfirm){
      	  	 if (isConfirm) {     
      	  	 	...
      	  	 	window.location.href = '/asset_entries/delete/' + id;
      	  	 }
      	  }
      	  )
 	...
 	if($('.sweet-inv').length){
	    document.querySelector('.sweet-inv').onclick = function(){
	        swal({
	          title: "Are you sure?", 
	          ...
	          swal({
	      	  ...
	      	  function(isConfirm){
	      	  	 if (isConfirm) {     
	      	  	 	...
	      	  	 	var url = window.location.pathname;
	      	  	 	var id = url.substring(url.lastIndexOf('/') + 1);
	      	  	 	window.location.href = '/inventory_entries/delete/' + id;
	      	  	 }
	      	  }
	      	  )
