  ...
  HIERARCHY = {
    ...
    objects: {
      ...
      'Sra' => {
        ...
        actions: [
          #TOP
          *%i[delete override_status launch edit deid_pdf pdf view_meeting view_parent viewer_access attach_in_message expand_all],
          #INLINE
      ...
      'Hazard' => {
        ...
        actions: [
          #TOP
          *%i[delete override_status launch edit deid_pdf pdf view_sra attach_in_message expand_all],
          #INLINE
      ...
      'RiskControl' => {
        ...
        actions: [
          #TOP
          *%i[delete override_status launch edit deid_pdf pdf view_hazard attach_in_message expand_all],
          #INLINE
