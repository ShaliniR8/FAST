  ...
  HIERARCHY = {
    ...
    objects: {
      ...
      'Sra' => {
        ...
        panels: %i[agendas comments source_of_input linked_sras audits hazards contacts costs tasks extension_requests verifications attachments transaction_log
