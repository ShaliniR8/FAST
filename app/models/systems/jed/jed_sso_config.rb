class JEDSsoConfig
    SAML_DATA = {
      ...
      access_point: 'https://jed.prodigiq.com',

      idp_slo_target_url: 'https://jed.prodigiq.com/saml/idp/logout',
      idp_sso_target_url: 'https://jed.prodigiq.com/saml/idp/auth',

      idp_entity_id: 'https://jed.prodigiq.com/saml/idp',
