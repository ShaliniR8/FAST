class ATNSafetyAssuranceConfig < DefaultSafetyAssuranceConfig
    ...
    objects: {
      ...
      'Finding' => {
        ...
        fields: {
          ...
          analysis_result: {
            field: 'analysis_result', title: 'Enter your Corrective Action Plan',
            num_cols: 12, type: 'textarea', visible: 'form,show',
            required: false
          },
          findings_comment: {
          ...
          anticipated_corrective_action_date: {
            field: 'anticipated_corrective_action_date', title: 'Anticipated Corrective Action Plan Implementation Date',
            num_cols: 6, type: 'date', visible: 'form,show',
            required: false
          },
          other: {
