  ...
  def self.categories
    {
      ...
      "CRM/TEM Skills" => [
        {name: "Automation Management", type: "check_box"},
        {name: "Communication", type: "check_box"},
        {name: "Leadership Effectiveness", type: "check_box"},
        {name: "Monitor/Cross-Check", type: "check_box"},
        {name: "Planning and Decision Making", type: "check_box"},
        {name: "Situation Awareness", type: "check_box"},
        {name: "Workload Management", type: "check_box"},
      ],
      "Cabin Equipment" => [
      ...
      "Just Culture" => [
        {name: "just-culture", type: "select", options: ["Human Error","At Risk Behavior","Reckless Behavior","Repetitive Human Behavior","Repetitive at Risk Behavior","External Organizational","External Individual","Not Applicable","Do not Consider Employee Action","System Design"]},
      ],
