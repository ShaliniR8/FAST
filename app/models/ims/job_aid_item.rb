class JobAidItem < ChecklistItem
  belongs_to :im,foreign_key:"owner_id",class_name: "JobAid"
  has_many :packages,foreign_key:"owner_id",class_name:"JobAidPackage",:dependent => :destroy
