...
#Association List
  ...
  def self.get_meta_fields(*args)
    ...
    return [
      ...
      { field: "res",             title: "Responsible User Name",     num_cols: 6,  type: "user",         visible: 'form,show',         required: false, censor_deid: true},
      { field: "app_id",          title: "Final Approver",            num_cols: 6,  type: "user",         visible: 'form,show',         required: false, censor_deid: true},
